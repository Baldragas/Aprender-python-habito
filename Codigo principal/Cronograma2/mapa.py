...
class Mapa:
    ...
    def dibujar_mapa_bonito(self):
        ...
        for hab in habitaciones_visitadas:
            ...
            enemigo = "⚔" if hab.enemigo and hasattr(hab.enemigo, 'esta_vivo') and hab.enemigo.esta_vivo() else " "
            objetos = "🎒" if hasattr(hab, 'objetos') and hab.objetos else " "
...
print("Recuerda, implementar mejoras de mapa")
